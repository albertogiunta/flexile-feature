  ...
  alb: {
    ...
    services: [
      ...
      },
      {
        name: "1 Day MVP",
        price: 500,
        description: "Conversion-ready prototype of your idea in one day",
        timesPerformed: 10,
        icon: "🚀",
        highlighted: true,
      },
      {
        name: "3 Day Project",
        price: 1500,
        description: "Small project or feature implementation",
        timesPerformed: 5,
        icon: "💻",
        highlighted: false,
      },
    ...
    externalLinks: [
      ...
      {
        name: "Read.cv",
        url: "https://read.cv/alb",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm4 18H6V4h7v5h5v11zM8 15h8v2H8v-2zm0-4h8v2H8v-2z"/></svg>`,
      },
    ],
  },
};
